...
4. Choose the file you would like to analyze from the below options:
    ...
    * A URL for an image of an ID document. You can use a [sample ID document](![image](https://user-images.githubusercontent.com/44625949/136572907-d02dd4a6-6a26-48bd-a793-b2523d69132e.png) for this quickstart.
